...
export default function HomepageHero() {
    ...
    return (
        <div className="relative min-h-screen flex flex-col lg:flex-row items-center justify-between p-6 lg:gap-12">
            ...
            <div className="relative flex flex-col items-start justify-center w-full lg:w-[500px] text-center lg:text-left">
                ...
                <div className="mt-8 flex gap-4">
                    <Button
                        size="icon"
                        className="flex items-center justify-center w-16 h-16 rounded-full border border-white bg-transparent"
                    >
                        <Bookmark size={64} />
                    </Button>
                    <Button
