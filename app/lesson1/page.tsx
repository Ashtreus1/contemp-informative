...
function Section1() {
	...
	return (
		<div className="bg-[#223030] flex flex-col items-center justify-center h-screen w-full relative">
			<motion.div className="text-center font-bold font-fjalla uppercase tracking-widest z-10" style={{ opacity: h1Opacity }}>
				<h1 className="text-6xl sm:text-7xl md:text-8xl lg:text-9xl text-white">Globalization</h1>
			</motion.div>
		...
		<div className="relative flex flex-col items-center justify-center h-screen w-full overflow-hidden">
			...
			<div className="relative min-h-screen flex justify-center items-end max-w-6xl px-6 sm:px-10">
				<p className="text-white sm:text-md md:text-lg lg:text-xl p-4 sm:p-6 md:p-10 font-semibold">
					Globalization describes the growing interdependence of the world’s economies, cultures, and populations, brought about by
					cross-border trade in goods and services, technology, and flows of investment, people, and information. Countries have built
					economic partnerships to facilitate these movements over many centuries. The term gained popularity after the Cold War in the
...
function Section3() {
	...
	return isLargeBreakpoint ? (
		<div ref={section3Ref} className="relative h-screen bg-[#223030] flex items-center justify-center overflow-hidden gap-5">
			<motion.p
			...
			>
				According to WHO, globalization can be defined as "the increased interconnectedness and interdependence of people and countries". It
				is generally understood to include two inter-related elements: the opening of international borders to increasingly fast flows of
				goods, services, finance, people and ideas; and the changes in institutions and policies at national and international levels that
		...
		<div ref={section3Ref} className="relative h-screen bg-[#223030] flex flex-col items-center justify-center overflow-hidden gap-5">
			<div className="h-[10px] bg-[#e8d9cd] w-80" />
			<Image src="/lesson1_imgs/images3.png" width={400} height={150} alt="Globalization Image" className="rounded-lg h-[300px] w-[300px]" />
...
const slidesContent = [
	{
		...
		text: (
			<>
				<h1 className="font-bold text-lg">What is Globalization in Geography?</h1>
				<p className="text-black text-md text-left mt-5">
					In geography, globalization is defined as the set of processese (economic, social, cultural, technological, institutional) that
					contribute to the relationship between societies and individuals around the world. It is a progressive process by which exchanges
	...
	},
	{
		...
		text: (
			<>
				<h1 className="font-bold text-lg">Examples of Globalization</h1>
				<p className="text-black text-md text-left mt-5">
				...
				<p className="text-black text-md text-left mt-5">
					...
					can be linked with the rise of a global financial system with internation financial exchanges and monetary exchanges. Stock
					markets, for instance, are a great example of th financially connected global world since when one stock market has a decline, it
		...
		text: (
			<>
				<p className="text-black text-md text-left">
					...
					refers to the interpenetration of cultures which, as a consequence, means nations adipt principles, beliefs, and customes of other
				...
				<p className="text-black text-md text-left mt-3">
					...
					the development and growing influence of international organizations such as the UN or WHO means governmental action takes place
					at an international level. There are other bodies operating at a global level such as NGos like DOctors without borders or Oxfam.
				</p>
			</>
		),
	},
		...
		text: (
			<>
				...
				<p className="text-black text-md text-left mt-3">
					...
					the phenomenon by which millions of people are interconnected thatnks to the power of the digital world via platformss such as
		...
		text: (
			<>
				<p className="text-black text-md text-left">
					...
					is the new organization and hierarchy of different regions of the world that is constantly changing. Moreoverm with transportation
					and flying made so easy and affordable, apart from a few countries with demanding visas, it is possible to travel the world
					without barely andy restrictions.
				</p>
				<p className="text-black text-md text-left mt-3 mb-5">
					<span className="font-bold">Ecological Globalization: </span>
					accounts for the idea of considering planet Earth as a single global entry - a common good all societies should protect since the
					weather affects everyone and we are all protected by the same atmosphere. To this regard, it is often said that the poorest
