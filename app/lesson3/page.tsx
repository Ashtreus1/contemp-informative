	...
	return (
		<section className="h-screen flex flex-col justify-center items-center bg-[url('/lesson3_imgs/bg-1.png')] bg-no-repeat bg-cover bg-center pt-20 relative snap-start">
			...
			<div className="flex items-center justify-center relative z-10">
				{[1, 2, 3, 4, 5].map((i) => (
					<div className="flex items-center justify-center gap-0" key={i}>
	...
	return (
		<section className="h-screen bg-[url('/lesson3_imgs/bg-1.png')] flex flex-col items-center justify-center sm:flex-row bg-no-repeat bg-cover bg-center sm:pt-20 flex relative snap-start">
			...
			<div className="sm:w-1/2  relative z-10 flex items-center justify-center">
				{/* <motion.div className="flex items-center justify-center" initial={{ x: "-100%" }} animate={{ x: 0 }} transition={{ duration: 1 }}> */}
...
function Section6() {
	return (
		<section className="h-screen bg-[url('/lesson3_imgs/bg-2.png')] bg-no-repeat bg-cover bg-center bg-[#40534C] snap-start flex flex-col items-center justify-center ">
			<div className="flex items-center justify-center">
...
function Section7() {
	return (
		<section className="h-screen bg-[url('/lesson3_imgs/bg-2.png')] flex flex-col justify-center bg-no-repeat bg-cover bg-center bg-[#49243E] snap-start">
			<h1 className="sm:pl-20 text-center sm:text-left text-3xl sm:text-4xl md:text-5xl font-bold text-white mt-5 sm:mt-10 uppercase">
				Silk Road {"(Silk Route)"}
			</h1>
			<div className="flex sm:flex-row flex-col items-center justify-evenly sm:p-5">
				<div className="w-4/5 sm:w-1/2 my-5">
					<img src="/lesson3_imgs/s7.png" />
				</div>
				<article className="sm:leading-relaxed grid sm:gap-10 text-white text-lg sm:text-2xl my-5">
					<p>• first global trade route in history</p>
					<p>• 1,500 years: 130 B.C.E. until 1453 C.E.</p>
					<p>• 6,437 kilometers (4,000 miles)</p>
				</article>
			</div>
			<article className="text-white text-lg sm:text-2xl px-10 sm:px-20 text-justify">
...
function Section8() {
	return (
		<section className="h-screen flex flex-col justify-center bg-[url('/lesson3_imgs/bg-2.png')] bg-no-repeat bg-cover bg-center bg-[#2E236C] snap-start">
			<h1 className="text-center text-xl sm:text-2xl md:text-4xl font-bold text-white uppercase lg:pt-10">GALLEON TRADE</h1>
			<div className="flex items-center justify-center flex-col sm:flex-row sm:p-10">
				<div className="grid sm:gap-10 text-white text-lg sm:text-2xl sm:pl-20 text-justify leading-relaxed w-4/5 sm:w-2/3">
	...
	return (
		<section className="h-screen flex flex-col justify-center bg-[url('/lesson3_imgs/bg-3.png')] bg-no-repeat bg-cover bg-center bg-[#31363F] snap-start">
			<div className="flex flex-col sm:flex-row items-center justify-center">
				...
				<div className="sm:w-1/2 text-white text-xl sm:text-2xl text-justify px-10">
			...
			<h1 className="text-center text-4xl md:text-5xl font-bold sm:mt-16 text-white uppercase">INTERNATIONAL MONETARY SYSTEM</h1>
		</section>
	);
}
...
function Section10() {
	return (
		<section className="h-screen flex flex-col justify-center items-center bg-[url('/lesson3_imgs/s10-bg.png')] text-black bg-no-repeat bg-cover bg-center bg-[#B9B4C7] snap-start">
			<h1 className="text-center text-3xl md:text-5xl font-bold uppercase ">ERA OF BIMETALLISM</h1>
			<div className="flex flex-col sm:flex-row items-center">
				<div className="sm:w-1/2 my-5 flex items-center justify-center">
	...
	return (
		<section className="">
			<section className="h-screen flex flex-col justify-center items-center bg-[url('/lesson3_imgs/s10-bg.png')] text-black bg-no-repeat bg-cover bg-center bg-[#D49B54] snap-start">
				<h1 className="text-center text-4xl md:text-5xl sm:pt-10 text-white font-bold uppercase sm:mb-5">Gold Standard</h1>
				<div className="flex flex-col sm:flex-row items-center justify-center">
					<div className="w-2/3 sm:w-1/2 flex items-center justify-center m-4">
						<img src="/lesson3_imgs/s11.png" alt="" className="w-3/4" />
					</div>
					<article className="sm:w-2/3 px-10 content-center text-xl sm:text-2xl text-justify text-black grid gap-10 sm:gap-16">
						<p>
			...
			<section className="h-screen flex flex-col justify-center items-center bg-[url('/lesson3_imgs/s10-bg.png')] text-black bg-no-repeat bg-cover bg-center bg-[#D49B54] snap-start">
				...
				<div className="flex flex-col sm:flex-row items-center justify-center">
					...
					<article className="sm:w-2/3 content-center text-lg sm:text-2xl text-justify px-10 text-black grid gap:10 sm:gap-16">
...
function Section12() {
	return (
		<section className="h-screen flex flex-col justify-center bg-[url('/lesson3_imgs/s10-bg.png')] text-black bg-no-repeat bg-cover bg-center bg-[#014DA7] snap-start">
			<h1 className="text-center text-4xl md:text-5xl text-white font-bold p-5 uppercase ">International Monetary Fund</h1>
			<div className="flex sm:flex-row flex-col items-center justify-center">
				<div className="sm:w-1/2 flex items-center justify-center">
					<img src="/lesson3_imgs/s12.png" alt="" className="w-3/4" />
				</div>
				<p className="sm:w-1/2 content-center text-xl sm:text-2xl text-justify px-20 text-white leading-loose">
...
function Section13() {
	return (
		<section className="h-screen flex flex-col justify-center bg-[url('/lesson3_imgs/s10-bg.png')] text-black bg-no-repeat bg-cover bg-center bg-[#503C3C] snap-start">
			<h1 className="text-center text-2xl lg:text-4xl md:text-5xl text-white font-bold sm:p-10 uppercase ">Bretton Woods System</h1>
			<div className="flex sm:flex-row flex-col items-center justify-center">
				<div className="w-2/4 sm:w-1/3 flex items-center justify-center">
					<img src="/lesson3_imgs/s13.png" alt="" className="w-3/4" />
				</div>
				<article className="sm:w-2/3 content-center text-lg sm:text-2xl text-justify px-10 text-white grid gap-4 sm:gap-14">
					<p>
...
function Section14() {
	return (
		<section className="h-screen flex flex-col justify-center items-center bg-[url('/lesson3_imgs/s10-bg.png')] text-black bg-no-repeat bg-cover bg-center bg-[#697565] snap-start text-white">
			...
			<p className="text-2xl text-justify px-10 sm:leading-[2.5]">“We have gold because we cannot trust governments,”</p>
		</section>
	);
}
...
function Section15() {
	return (
		<section className="h-screen flex flex-col justify-center items-center bg-[url('/lesson3_imgs/s10-bg.png')] text-black bg-no-repeat bg-cover bg-center bg-[#1F6E8C] snap-start">
			<h1 className="text-center text-4xl md:text-5xl text-white font-bold p-5 uppercase ">WORLD BANK</h1>
			<div className="flex sm:flex-row flex-col items-center justify-center">
				<div className="sm:w-1/2 flex items-center justify-center">
					<img src="/lesson3_imgs/s15.png" alt="" className="w-3/4" />
				</div>
				<p className="sm:w-1/2 content-center text-xl sm:text-3xl text-justify px-20 text-white leading-loose">
	...
	return (
		<section>
			<section className="h-screen flex flex-col justify-center bg-[url('/lesson3_imgs/s10-bg.png')] text-black bg-no-repeat bg-cover bg-center bg-[#3D3D42] snap-start">
				<h1 className="text-center text-4xl md:text-5xl text-white font-bold p-5 uppercase ">FIAT MONETARY SYSTEM</h1>
				<div className="flex sm:flex-row flex-col items-center justify-center">
					<div className="sm:w-1/2 flex items-center justify-center">
						<img src="/lesson3_imgs/s16.png" alt="" className="w-3/5" />
					</div>
					<article className="sm:w-1/2 content-center text-lg sm:text-2xl text-justify px-10 text-white leading-loose grid sm:gap-10">
			...
			<section className="h-screen flex flex-col justify-center bg-[url('/lesson3_imgs/s10-bg.png')] text-black bg-no-repeat bg-cover bg-center bg-[#3D3D42] snap-start">
				...
				<div className="flex sm:flex-row flex-col items-center justify-center">
					...
					<article className="sm:w-1/2 content-center text-lg sm:text-2xl text-justify px-10 text-white grid gap-4 sm:gap-10">
						<div className="">
	...
	return (
		<section className="h-screen flex flex-col justify-center bg-[url('/lesson3_imgs/s10-bg.png')] text-black bg-no-repeat bg-cover bg-center bg-[#7E6363] snap-start">
			...
			<div className="flex justify-center sm:flex-row flex-col items-center">
				...
				<article className="sm:w-1/2 content-center text-lg sm:text-2xl text-justify px-10 text-white grid gap-10">
					<p>
