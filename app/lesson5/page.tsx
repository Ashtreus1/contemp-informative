...
function Template1({ item, index }: any) {
	return (
		<Section className={``}>
			<LeftAnim className={`${imgContainerStyle} `} duration={duration}>
				<img src={`/lesson5_imgs/s5-img-${index}.png`} alt={item.title} className={imgStyle} />
			</LeftAnim>
			<RightAnim className={`${articleStyle} `} duration={duration}>
...
function Template2({ item, index }: any) {
	return (
		<Section className={`flex-col-reverse bg-[#303030] sm:bg-[#1e1e1e]`}>
			...
			<RightAnim className={imgContainerStyle} duration={duration}>
				<img src={`/lesson5_imgs/s5-img-${index}.png`} alt={item.title} className={imgStyle} />
			</RightAnim>
		</Section>
	);
